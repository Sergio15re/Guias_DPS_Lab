...
import Cita from './src/components/Reserva';
...
const App = () => {
 ...
 style={styles.btnMostrarForm}>
  <Text style={styles.textoMostrarForm}> {mostrarform ? 'Cancelar Creación de Reserva' : 'Agregar Nueva Reserva'} </Text>
  </TouchableHighlight>
  </View>
  <View style={styles.contenido}>
  { mostrarform ? (
  <>
  <Text style={styles.titulo}>Agregar Nueva Reserva</Text>
  <Formulario
  citas={citas}
  setCitas={setCitas}
